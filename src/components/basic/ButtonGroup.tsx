...
export default class ButtonGroup<P extends typeof props, S extends state> extends Tag.default<P, S> {
    ...
    private getButtons() {
        ...
        if(children instanceof Array) {
            children.map((child: any, index)=>{
                let button = child;
                if(button && button.type && ObjectUtil.isInstance(button.type, "Button")) {
