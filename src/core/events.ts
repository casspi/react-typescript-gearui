let events = {
    ...
    onBeforeCellSave: GearType.Function,
    onBeforeCellEdit: GearType.Function,
    onBeforeCellReset: GearType.Function,
    onBeforeCheck: GearType.Function,
    onBeforeClear: GearType.Function,
    onBeforeCollapse: GearType.Function,
    onBeforeEdit: GearType.Function,
    ...
    onBeforeReset: GearType.Function,
    onBeforeRowAdd: GearType.Function,
    onBeforeRowDown: GearType.Function,
    onBeforeRowEdit: GearType.Function,
    onBeforeRowDelete: GearType.Function,
    onBeforeRowReset: GearType.Function,
    onBeforeRowSave: GearType.Function,
    onBeforeRowUp: GearType.Function,
    onBeforeSave: GearType.Function,
    ...
    onRowDelete: GearType.Function,
    onRowSave: GearType.Function,
    ...
    onTitleClick: GearType.Function,
