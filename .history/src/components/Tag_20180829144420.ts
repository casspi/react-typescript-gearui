...
export default abstract class Tag<P extends NonNullable<typeof props>, S extends state> extends JqueryTag<P, S> {
    ...
    protected afterReceiveProps(nextProps: P): P {return <any>{}};
