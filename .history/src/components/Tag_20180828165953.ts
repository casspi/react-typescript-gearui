...
export default abstract class Tag<P extends typeof props, S extends state> extends JqueryTag<P, S> {
    ...
    protected getConcatInitialState() {
        ...
        console.log(Object.getPrototypeOf(this.constructor).prototype.getInitialState);
        // let s = Object.getOwnPropertyDescriptor(this.constructor.__proto__.prototype, "getInitialState");
        // console.log(s);
        let state = this.getInitialState();
        // console.log(this.constructor.prototype.getInitialState);
        if(this.constructor && this.constructor.prototype) {
            let __super = this.constructor.prototype;
            let fn = this.constructor.prototype.getInitialState;
            // while(fn) {
                // let superState = fn.bind(this)();
                // state = G.G$.extend(superState, state);
                // __super = __super.prototype;
                // fn = __super.getInitialState;
            // }
        }
        ...
        //     console.log(super.getConcatInitialState);
