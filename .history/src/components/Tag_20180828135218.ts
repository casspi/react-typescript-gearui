...
export default abstract class Tag<P extends typeof props, S extends state> extends JqueryTag<P, S> {
    ...
    protected __super: Tag<any, any>;
    constructor(props: P, context?: any) {
        super(props, context);
        this.__super = eval("_super");
        this.getConcatInitialState = this.getConcatInitialState.bind(this);
        this.state = <Readonly<S>>this.getInitState();
    }

    abstract initSuper<T>() : T extends Tag<any, any>;
